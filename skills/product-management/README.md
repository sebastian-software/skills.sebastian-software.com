...
# Product Management — moved

**This skill has moved into [effective-product](../effective-product/README.md).**

`product-management` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Discovery and Evidence Review, Strategy and Operating Model, and Scope, Quality, and Shipping
...
If you previously selected `product-management`, drop that selection when you add the
successor.
