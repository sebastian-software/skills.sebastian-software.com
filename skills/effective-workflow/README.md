...
# Effective Workflow — moved

**This skill has moved into [effective-delivery](../effective-delivery/README.md).**

`effective-workflow` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Workflow Orchestration (references/route-orchestration.md)
...
If you previously selected `effective-workflow`, drop that selection when you add the
successor.
