...
`effective-workflow` is a deprecation stub. It stays installable for one release
...
If you previously selected `effective-workflow`, drop that selection when you add
the successor.
