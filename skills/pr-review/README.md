...
`pr-review` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** PR Review and Upkeep (references/route-review.md)
...
If you previously selected `pr-review`, drop that selection when you add the
successor.
