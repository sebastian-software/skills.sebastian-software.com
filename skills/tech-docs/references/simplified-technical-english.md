...
- Use `metro-english` for relaxed Slack, GitHub, Linear, PR, and internal team
  communication.
- Use the general `tech-docs` workflow for clear technical English when no
...
`metro-english`; the controlled document itself cannot.
