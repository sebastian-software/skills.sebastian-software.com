...
`tech-docs` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Technical Documentation (references/route-docs.md)
...
If you previously selected `tech-docs`, drop that selection when you add the
successor.
