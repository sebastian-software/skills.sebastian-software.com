...
Choose the route for the marketing decision or requested artifact and load
references as needed. Use the supplied brief when it is sufficient.

Keep product evidence, market position, message, and channel tactic distinct.
Never invent quotations, testimonials, outcomes, competitor behavior,
differentiation, scarcity, or deadlines. Preserve the qualifications that make
claims true; channel response alone does not prove a product claim.
...
- `effective-web`: page hierarchy, interface copy, implementation, analytics,
