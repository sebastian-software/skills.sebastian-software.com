...
2. Establish the commercial evidence. Read
   [Positioning and offer](linkedin-positioning-and-offer.md) unless the target
   buyer, problem, proof, first-step offer, and larger offer are already
   explicit. Mark assumptions; never invent customer language, testimonials,
...
4. Load only the matching reference:
   - [Inbound profile](linkedin-inbound-profile.md) for the acquisition
     overlay: target-buyer path, campaign proof, Featured choices, calls to
     action, and downstream measurement. Use **Profile** for
     field-level profile content and professional evidence.
   - [Network and conversations](linkedin-network-and-conversations.md) for
     prospect discovery, connection routines, welcome messages, outreach,
     follow-up, qualification, and meeting transitions.
   - [Content system](linkedin-content-system.md) for content roles, source
     evidence, production, distribution, and measurement. Route actual post
     ideas, calendars, formats, and drafting through
     **LinkedIn posts**.
   - [Lead magnet and funnel](linkedin-lead-magnet-and-funnel.md) for opt-in
...
- Read accepted ADRs and existing brand or editorial guidance before defining
  ...
  direction, record it as an ADR through `effective-product` instead of creating
  a LinkedIn-specific memory file.
...
- Post ideation, calendars, formats, drafting, and rewriting — including posts
  inside an end-to-end engagement — belong to
  **LinkedIn posts**. Pass it the audience, content role,
  evidence, and commercial intent established here.
- A content program spanning LinkedIn and other platforms, or with the platform
  still open, belongs to **Social content**.
- Professional evidence, field-level profile content, project history,
  biography, and cross-channel profile consistency belong to
  **Profile**; return here for the acquisition overlay.
- Cross-channel segmentation, category choice, positioning, messaging, proof,
  launches, and market learning are settled in
  **Positioning** and **Messaging**.
- Landing pages, forms, analytics delivery, accessibility, performance,
  responsive behavior, and the tracking, consent, lead-form, testimonial, and
