...
evidence, and voice brief here and hand the LinkedIn expression to that route.
...
1. Define the assignment:
   ...
   when a missing choice would materially change the content.
2. Establish the evidence boundary. Read accepted ADRs and existing brand,
   ...
   Read [Source, voice, and content history](source-and-voice.md) when the task
   depends on personal or product context, voice matching, published-content
   history, or a freshness claim.
...
- LinkedIn positioning, target buyers, profiles, networks, conversations, lead
...
- Professional positioning, career evidence, project facts, and
  permission-sensitive client context are established in
  **Profile** before becoming public posts.
- The standalone article, essay, newsletter, or case study behind the social
  content, and any requested evidence-based audit of formulaic prose, belong to
  `effective-writing`. Never infer authorship from prose patterns.
- Durable cross-channel choices about audience relationship, voice, tone,
  terminology, claims, and channel exceptions are recorded as ADRs through
  `effective-product`.
- Locale-specific visible prose belongs to `effective-writing`; advertising,
  endorsement, testimonial, promotion, privacy, and jurisdiction-specific
  disclosure requirements belong to `effective-web`.
