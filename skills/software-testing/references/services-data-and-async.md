...
Measure the path that matters and report environment limits. Route load, soak,
capacity, comprehensive benchmarking methodology, and performance targets that
need architecture tradeoffs to `software-architecture`; route browser
performance to `effective-web`.
