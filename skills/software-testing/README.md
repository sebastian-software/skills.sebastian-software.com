...
`software-testing` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Focused Testing (references/route-testing.md) and Benchmark Methodology (references/route-benchmarks.md)
...
If you previously selected `software-testing`, drop that selection when you add the
successor.
