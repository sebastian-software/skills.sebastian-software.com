...
# Conversion Optimization — moved

**This skill has moved into [effective-marketing](../effective-marketing/README.md).**

`conversion-optimization` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Conversion Optimization (references/route-conversion.md)
...
If you previously selected `conversion-optimization`, drop that selection when you add the
successor.
