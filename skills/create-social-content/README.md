...
# Create Social Content — moved

**This skill has moved into [effective-marketing](../effective-marketing/README.md).**

`create-social-content` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Social Content (references/route-social.md)
...
If you previously selected `create-social-content`, drop that selection when you add the
successor.
