...
- [html-accessibility.md](html-accessibility.md) - semantic structure, ARIA repair layer, accessible names, forms/labels, focus management, live regions, composite widgets, state-driven styling, contrast/target size/reduced-motion/forced-colors, and a review checklist.
