...
# Consultant Profile — moved

**This skill has moved into [effective-marketing](../effective-marketing/README.md).**

`consultant-profile` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Consultant Profile (references/route-profile.md)
...
If you previously selected `consultant-profile`, drop that selection when you add the
successor.
