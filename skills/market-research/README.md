...
# Market Research — moved

**This skill has moved into [effective-product](../effective-product/README.md).**

`market-research` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Customer and Market Research (references/route-research.md)
...
If you previously selected `market-research`, drop that selection when you add the
successor.
