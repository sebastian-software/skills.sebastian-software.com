...
# Port Codebases — moved

**This skill has moved into [effective-delivery](../effective-delivery/README.md).**

`port-codebases` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Behavior-Preserving Ports (references/route-porting.md)
...
If you previously selected `port-codebases`, drop that selection when you add the
successor.
