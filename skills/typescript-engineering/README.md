...
# TypeScript Engineering — moved

**This skill has moved into [effective-engineering](../effective-engineering/README.md).**

`typescript-engineering` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** TypeScript Engineering (references/route-typescript.md)
...
If you previously selected `typescript-engineering`, drop that selection when you add the
successor.
