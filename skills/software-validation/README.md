...
# Software Validation — moved

**This skill has moved into [effective-delivery](../effective-delivery/README.md).**

`software-validation` is a deprecation stub. It stays installable for one release window so
...
**Where it went:** Repository Validation (references/route-validation.md)
...
If you previously selected `software-validation`, drop that selection when you add the
successor.
