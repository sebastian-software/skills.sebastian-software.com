# Cluster Brief: Marketing Misclassified

## Scope

Review the two remaining open `Skill: Marketing` intake items. Both were
heuristic misclassifications. No skill files were changed.
...
- Do not create or update marketing skills from these sources.
- Route Anchor Positioning to a future Frontend UI modern CSS pass.
- Defer developer-to-manager material until there is a broader leadership
  source cluster.
