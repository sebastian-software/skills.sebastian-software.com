...
7 practice-built skills, 338 focused references, and 2 optional instruction packs
...
| --- | --- | --- | --- |
| 01 | [`effective-product`](skills/effective-product/) | Decide what to build and how it should work | 11 |
...
| Develop a new application concept or review it before implementation planning | [`effective-product`](skills/effective-product/) |
